 ...
 * 데이터 딕셔너리는 사용자가 테이븡을 생성하거나, 사용자를 변경하는 등의
...
-- SQL 작성법 : 대문자 작성권장, 연결된 단어 사이는 "_" 사용
...
-- 테이블 생성 시 해당 컬럼에 저장된 DEFAULT 값으로 삽입이 된다

INSERT INTO MEMBER VALUES('MEM02','ABC234', '구길동', '951022-2234567', DEFAULT);
INSERT INTO MEMBER VALUES('MEM03','456ABC', '한지동', '970312-1234567', SYSDATE);

INSERT INTO MEMBER (MEMBER_ID, MEMBER_PWD, MEMBER_NAME)
VALUES('MEM04', 'TTD123', '이지연');

-- ** JDBC에서 날짜를 입력받았을 때 삽입하는 방법 **
-- '2022-09-13 17:33:27'
INSERT INTO MEMBER VALUES('MEM05','780ABC', '김길동', '930325-1234567',
...
INSERT INTO MEMBER2 VALUES('MEM02', 'PASS02','고길순', 0102341234);
...
-- 단, UNQUE 제약조건이 설정된 컬럼에 NULL값은 중복 삽입 가능
...
CREATE TABLE USER_USED_UK2(
	...
	/* 테이블 레벨 */
	-- UNIQUE(USER_ID) -- 테이블레벨(제약조건명 미지정)
	CONSTRAINT USER_ID_NAME_U UNIQUE(USER_ID, USER_NAME) -- 테이블레벨(제약조건명 지정)
);
...
INSERT INTO USER_USED_PK
VALUES(1,'USER02', 'PASS02', '이순신','남', '010-1234-5678', 'Lee134@kh.or.kr');

INSERT INTO USER_USED_PK
VALUES(NULL,'USER01', 'PASS01', '홍길동','남', '010-1234-5678', 'hong1234@kh.or.kr');


-------------------------------------------------------------------

-- PRIMARY KEY 복합키 (테이블레벨만 가능)
...
CREATE TABLE USER_USED_PK2(
	...
	EMAIL VARCHAR2(50),
	-- 테이블 레벨
	CONSTRAINT USER_NO_ID_PK PRIMARY KEY(USER_ID, USER_NO)
);
...
INSERT INTO USER_USED_PK2
VALUES(2,'USER02', 'PASS02', '유관순','남', '010-1234-5678', 'Lee134@kh.or.kr');

-- 회원번호와 아이디 둘 다 중복되었을 때만 제약조건 위배 에러 발생

INSERT INTO USER_USED_PK2
VALUES(NULL, NULL, 'PASS02', '이순신','남', '010-1234-5678', 'Lee134@kh.or.kr');
...
-- 참조할 테이블의 참조할 컬럼며이 생략되면, PRIMARY KEY로 설정된 컬럼이 자동 참조할 컬럼이 됨
...
INSERT INTO USER_USED_CHECK
VALUES(1,'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678','hong1234@kh.or.kr');
-- ORA-02290: 체크 제약조건(KH.GENDER_CHECK)이 위배되었습니다
-- GENDER 컬럼에 CHECK 제약 조건으로 '남', '여' 만 기록 가능한데
-- '남자'라는 조건 외의 값이 들어와 에러 발생
...
CREATE TABLE USER_TEST(
	USER_NO NUMBER ,
	USER_ID VARCHAR2(20) CONSTRAINT USER_TEST UNIQUE,
	USER_PWD VARCHAR2(20) NOT NULL,
	PNO VARCHAR2(30),
	GENDER VARCHAR2(10) CONSTRAINT GENDER_CHECK2 CHECK(GENDER IN('남', '여')),
	PHONE VARCHAR2(30),
	ADDRESS VARCHAR2(50),
	STATUS VARCHAR2(20) NOT NULL,
	CONSTRAINT USER_NO_PNO_TEST PRIMARY KEY (USER_NO, PNO),
...
VALUES(1,'USER01', 'PASS01', '993456-1234567', '남', '010-1234-5678','서울', 'N' );

INSERT INTO USER_TEST
VALUES(2,'USER02', 'PASS01', '993456-1234567', '여', '010-1234-5678','서울', 'N');

INSERT INTO USER_TEST 
VALUES(3,'USER03', 'PASS01', '993456-1234567', '남', '010-1234-5678','서울', 'N' );

INSERT INTO USER_TEST 
VALUES(4,'USER04', 'PASS01', '993456-1234567', '여', '010-1234-5678','서울', 'N' );

INSERT INTO USER_TEST 
VALUES(5,'USER05', 'PASS01', '993456-1234567', '여', '010-1234-5678','서울', 'N' );
...
-- 컬럼명, 데이터 타빙, 값이 복사되고, 제약조건은 NOT NULL만 복사됨
...
-- 참조테이블은 DEPARTMENT, 참조컬럼은 DEPARTMENT의 기본키
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT DEPT_LACAL_ID
...
ALTER TABLE LOCATON ADD CONSTRAINT LOCAL_NATION_CODE
